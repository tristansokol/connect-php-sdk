...
------------- | ------------- | -------------
[**createEmployee**](EmployeesApi.md#createEmployee) | **POST** /v1/me/employees | Creates an employee for a business.
[**createEmployeeRole**](EmployeesApi.md#createEmployeeRole) | **POST** /v1/me/roles | Creates an employee role you can then assign to employees.
[**createTimecard**](EmployeesApi.md#createTimecard) | **POST** /v1/me/timecards | Creates a timecard for an employee. Each timecard corresponds to a single shift.
[**deleteTimecard**](EmployeesApi.md#deleteTimecard) | **DELETE** /v1/me/timecards/{timecard_id} | Deletes a timecard. Deleted timecards are still accessible from Connect API endpoints, but the value of their deleted field is set to true. See Handling deleted timecards for more information.
[**listCashDrawerShifts**](EmployeesApi.md#listCashDrawerShifts) | **GET** /v1/{location_id}/cash-drawer-shifts | Provides the details for all of a location&#39;s cash drawer shifts during a date range. The date range you specify cannot exceed 90 days.
[**listEmployeeRoles**](EmployeesApi.md#listEmployeeRoles) | **GET** /v1/me/roles | Provides summary information for all of a business&#39;s employee roles.
[**listEmployees**](EmployeesApi.md#listEmployees) | **GET** /v1/me/employees | Provides summary information for all of a business&#39;s employees.
[**listTimecardEvents**](EmployeesApi.md#listTimecardEvents) | **GET** /v1/me/timecards/{timecard_id}/events | Provides summary information for all events associated with a particular timecard.
[**listTimecards**](EmployeesApi.md#listTimecards) | **GET** /v1/me/timecards | Provides summary information for all of a business&#39;s employee timecards.
[**retrieveCashDrawerShift**](EmployeesApi.md#retrieveCashDrawerShift) | **GET** /v1/{location_id}/cash-drawer-shifts/{shift_id} | Provides the details for a single cash drawer shift, including all events that occurred during the shift.
[**retrieveEmployee**](EmployeesApi.md#retrieveEmployee) | **GET** /v1/me/employees/{employee_id} | Provides the details for a single employee.
[**retrieveEmployeeRole**](EmployeesApi.md#retrieveEmployeeRole) | **GET** /v1/me/roles/{role_id} | Provides the details for a single employee role.
[**retrieveTimecard**](EmployeesApi.md#retrieveTimecard) | **GET** /v1/me/timecards/{timecard_id} | Provides the details for a single timecard.
[**updateEmployee**](EmployeesApi.md#updateEmployee) | **PUT** /v1/me/employees/{employee_id} | v1UpdateEmployee
[**updateEmployeeRole**](EmployeesApi.md#updateEmployeeRole) | **PUT** /v1/me/roles/{role_id} | Modifies the details of an employee role.
[**updateTimecard**](EmployeesApi.md#updateTimecard) | **PUT** /v1/me/timecards/{timecard_id} | Modifies a timecard&#39;s details. This creates an API_EDIT event for the timecard. You can view a timecard&#39;s event history with the List Timecard Events endpoint.


# **createEmployee**
> \SquareConnect\Model\Employee createEmployee($body)
...
$body = new \SquareConnect\Model\Employee(); // \SquareConnect\Model\Employee | An object containing the fields to POST for the request.  See the corresponding object definition for field details.
...
------------- | ------------- | ------------- | -------------
 **body** | [**\SquareConnect\Model\Employee**](../Model/\SquareConnect\Model\Employee.md)| An object containing the fields to POST for the request.  See the corresponding object definition for field details. |

### Return type

[**\SquareConnect\Model\Employee**](../Model/Employee.md)
...
# **createEmployeeRole**
> \SquareConnect\Model\EmployeeRole createEmployeeRole($employee_role)
...
$api_instance = new SquareConnect\Api\EmployeesApi();
$employee_role = new \SquareConnect\Model\EmployeeRole(); // \SquareConnect\Model\EmployeeRole | An EmployeeRole object with a name and permissions, and an optional owner flag.

try {
    $result = $api_instance->createEmployeeRole($employee_role);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling EmployeesApi->createEmployeeRole: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **employee_role** | [**\SquareConnect\Model\EmployeeRole**](../Model/\SquareConnect\Model\EmployeeRole.md)| An EmployeeRole object with a name and permissions, and an optional owner flag. |

### Return type

[**\SquareConnect\Model\EmployeeRole**](../Model/EmployeeRole.md)
...
# **createTimecard**
> \SquareConnect\Model\Timecard createTimecard($body)
...
$api_instance = new SquareConnect\Api\EmployeesApi();
$body = new \SquareConnect\Model\CreateTimecardRequest(); // \SquareConnect\Model\CreateTimecardRequest | An object containing the fields to POST for the request.  See the corresponding object definition for field details.

try {
    $result = $api_instance->createTimecard($body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling EmployeesApi->createTimecard: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\SquareConnect\Model\CreateTimecardRequest**](../Model/\SquareConnect\Model\CreateTimecardRequest.md)| An object containing the fields to POST for the request.  See the corresponding object definition for field details. |

### Return type

[**\SquareConnect\Model\Timecard**](../Model/Timecard.md)
...
try {
    ...
    echo 'Exception when calling EmployeesApi->deleteTimecard: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \SquareConnect\Model\CashDrawerShift[] listCashDrawerShifts($location_id, $order, $begin_time, $end_time)
...
try {
    ...
    echo 'Exception when calling EmployeesApi->listCashDrawerShifts: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\SquareConnect\Model\CashDrawerShift[]**](../Model/CashDrawerShift.md)
...
# **listEmployeeRoles**
> \SquareConnect\Model\EmployeeRole[] listEmployeeRoles($order, $limit, $cursor)
...
try {
    ...
    echo 'Exception when calling EmployeesApi->listEmployeeRoles: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **listEmployees**
> \SquareConnect\Model\Employee[] listEmployees($order, $begin_updated_at, $end_updated_at, $begin_created_at, $end_created_at, $status, $external_id, $limit)
...
# **listTimecardEvents**
> \SquareConnect\Model\TimecardEvent[] listTimecardEvents($timecard_id)
...
try {
    ...
    echo 'Exception when calling EmployeesApi->listTimecardEvents: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\SquareConnect\Model\TimecardEvent[]**](../Model/TimecardEvent.md)
...
# **listTimecards**
> \SquareConnect\Model\Timecard[] listTimecards($order, $employee_id, $begin_clockin_time, $end_clockin_time, $begin_clockout_time, $end_clockout_time, $begin_updated_at, $end_updated_at, $deleted, $limit, $cursor)
...
try {
    ...
    echo 'Exception when calling EmployeesApi->listTimecards: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \SquareConnect\Model\CashDrawerShift retrieveCashDrawerShift($location_id, $shift_id)
...
try {
    ...
    echo 'Exception when calling EmployeesApi->retrieveCashDrawerShift: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **retrieveEmployee**
> \SquareConnect\Model\Employee retrieveEmployee($employee_id)
...
> \SquareConnect\Model\EmployeeRole retrieveEmployeeRole($role_id)
...
try {
    ...
    echo 'Exception when calling EmployeesApi->retrieveEmployeeRole: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **retrieveTimecard**
> \SquareConnect\Model\Timecard retrieveTimecard($timecard_id)
...
try {
    ...
    echo 'Exception when calling EmployeesApi->retrieveTimecard: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **updateEmployee**
> \SquareConnect\Model\Employee updateEmployee($employee_id, $body)
...
$body = new \SquareConnect\Model\UpdateEmployeeRequest(); // \SquareConnect\Model\UpdateEmployeeRequest | An object containing the fields to POST for the request.  See the corresponding object definition for field details.
 ...
 **body** | [**\SquareConnect\Model\UpdateEmployeeRequest**](../Model/\SquareConnect\Model\UpdateEmployeeRequest.md)| An object containing the fields to POST for the request.  See the corresponding object definition for field details. |
...
# **updateEmployeeRole**
> \SquareConnect\Model\EmployeeRole updateEmployeeRole($role_id, $body)
...
$body = new \SquareConnect\Model\EmployeeRole(); // \SquareConnect\Model\EmployeeRole | An object containing the fields to POST for the request.  See the corresponding object definition for field details.

try {
    $result = $api_instance->updateEmployeeRole($role_id, $body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling EmployeesApi->updateEmployeeRole: ', $e->getMessage(), PHP_EOL;
}
?>
```
 ...
 **body** | [**\SquareConnect\Model\EmployeeRole**](../Model/\SquareConnect\Model\EmployeeRole.md)| An object containing the fields to POST for the request.  See the corresponding object definition for field details. |
...
# **updateTimecard**
> \SquareConnect\Model\Timecard updateTimecard($timecard_id, $body)
...
$body = new \SquareConnect\Model\UpdateTimecardRequest(); // \SquareConnect\Model\UpdateTimecardRequest | An object containing the fields to POST for the request.  See the corresponding object definition for field details.

try {
    $result = $api_instance->updateTimecard($timecard_id, $body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling EmployeesApi->updateTimecard: ', $e->getMessage(), PHP_EOL;
}
?>
```
 ...
 **body** | [**\SquareConnect\Model\UpdateTimecardRequest**](../Model/\SquareConnect\Model\UpdateTimecardRequest.md)| An object containing the fields to POST for the request.  See the corresponding object definition for field details. |
