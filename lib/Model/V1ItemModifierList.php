...
/**
 * V1ItemModifierList Class Doc Comment
 *
 * @category    Class */
/**
 * @package     SquareConnect
 ...
 */
class V1ItemModifierList implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1ItemModifierList';
    ...
    protected static $swaggerTypes = [
        ...
        'modifier_options' => '\SquareConnect\Model\V1ItemModifierOption[]'
    ];
    ...
    const SELECTION_TYPE_DOUBLE = 'DOUBLE';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['selection_type'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'selection_type', must be one of #{allowed_values}.";
        }
    ...
    {
        $allowed_values = array('SINGLE', 'DOUBLE');
        if (!is_null($selection_type) && (!in_array($selection_type, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'selection_type', must be one of 'SINGLE', 'DOUBLE'");
        }
     ...
     * @param \SquareConnect\Model\V1ItemModifierOption[] $modifier_options The options included in the modifier list.
     * @return $this
     */
