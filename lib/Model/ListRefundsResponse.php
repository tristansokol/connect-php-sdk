 ...
 *
 * @category    Class */
 // @description Defines the fields that are included in the response body of a request to the **ListTenderRefunds** endpoint.  One of &#x60;errors&#x60; or &#x60;refunds&#x60; is present in a given response (never both).
/**
 * @package     SquareConnect
...
class ListRefundsResponse implements ArrayAccess
{
    ...
    /**
     * Sets cursor
     * @param string $cursor A pagination cursor for retrieving the next set of results, if any remain.  Provide this value as the `cursor` parameter in a subsequent request to the **ListTenderRefunds** endpoint.
     * @return $this
     */
